...
class Yolov8Visualizer(Node):
  ...
  def detections_callback(self, detections_msg: Detection2DArray, img_msg: Image):
    txt_color = (255, 0, 255)
    ...
    for detection in detections_msg.detections:
      ...
      conf_score: float = detection.results[0].hypothesis.score
      label: str = f'{label} {conf_score:.2f}'
      ...
      # text width, height
      _, h = cv2.getTextSize(label, 0, fontScale=lw / 3, thickness=tf)[0]
